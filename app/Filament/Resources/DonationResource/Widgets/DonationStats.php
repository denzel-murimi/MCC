...
class DonationStats extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $countThisYear = Donation::whereYear('created_at','=', $currentYear)->count();
        ...
        $totalThisYear = Donation::whereYear('created_at','=', $currentYear)->sum('amount');
        ...
        for ($i = 6; $i >= 0; $i--) {
            ...
            $dailyAmount = Donation::whereDate('created_at','=', $date->toDateString())->sum('amount');
            $last7Days[] = $dailyAmount;
        }

        return [
            Stat::make('Donations (This Month)', number_format($countThisMonth))
