    ...
    <div class="container max-w-screen-xxl mx-auto px-4">
        <div class="flex flex-col lg:flex-row lg:justify-between">
            ...
            <div class="space-y-7 mb-10 lg:mb-0">
                ...
                <p class="font-light text-gray-400 text-md md:text-lg text-center lg:text-left">Donate and help us take care of our children</p>
            ...
            <div class="text-center lg:text-left space-y-7 mb-10 lg:mb-0">
                ...
                <a href="#" class="block font-light text-gray-400 text-sm md:text-lg hover:text-gray-800 transition ease-in-out duration-300">Donate Now</a>

                <a href="#" class="block font-light text-gray-400 text-sm md:text-lg hover:text-gray-800 transition ease-in-out duration-300">Volunteer Sign-Up</a>

                {{-- <a href="#" class="block font-light text-gray-400 text-sm md:text-lg hover:text-gray-800 transition ease-in-out duration-300">Gallery</a> --}}
            ...
            <div class="text-center lg:text-left space-y-7 mb-10 lg:mb-0">
                ...
                <a href="#" class="block font-light text-gray-400 text-sm md:text-lg hover:text-gray-800 transition ease-in-out duration-300">Our Staff</a>

                {{-- <a href="#" class="block font-light text-gray-400 text-sm md:text-lg hover:text-gray-800 transition ease-in-out duration-300">Volunteer</a> --}}
