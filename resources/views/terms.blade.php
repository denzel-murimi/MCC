...
<section class="p-8 bg-white">
    <h2 class="text-3xl font-bold text-center">Terms & Conditions</h2>

    <div class="mt-8 max-w-3xl mx-auto">

        <h3 class="text-2xl font-semibold mt-6">1. Introduction</h3>
        <p class="mt-2 text-gray-700">
            Welcome to Mathare Care Center. By accessing or using our website, you agree to comply with and be bound by these Terms & Conditions. If you do not agree, please refrain from using our services.
        </p>

        <h3 class="text-2xl font-semibold mt-6">2. Use of the Website</h3>
        <p class="mt-2 text-gray-700">
            Our website is intended to provide information about our initiatives, accept donations, and allow users to engage with our programs. You agree to use this website only for lawful purposes and in a manner that does not infringe the rights of, or restrict or inhibit, any other user.
        </p>
        ...
        <h3 class="text-2xl font-semibold mt-6">9. Amendments to Terms</h3>
        <p class="mt-2 text-gray-700">
            We reserve the right to update or modify these Terms & Conditions at any time. Continued use of the website after changes are made constitutes acceptance of the revised terms.
        </p>

        <h3 class="text-2xl font-semibold mt-6">10. Contact Us</h3>
        <p class="mt-2 text-gray-700">
            If you have any questions about these Terms & Conditions, please contact us at <a href="mailto:matharedaycarecenter@gmail.com" class="text-blue-600">matharedaycarecenter@gmail.com</a>.
        </p>
    </div>
</section>
</x-layout>
