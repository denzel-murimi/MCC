        ...
        <div class="container max-w-screen-xxl mx-auto px-4">
            ...
            <div class="flex flex-col lg:flex-row justify-between space-x-20">
                <div class="text-center lg:text-left mt-40">
                    ...
                    <p class="font-light text-gray-400 text-md md:text-lg leading-normal mb-12">We provide care for disabledannel for peoples of <br> worldwide to support people and organizers</p>
