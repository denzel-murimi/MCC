...
<body class="bg-gray-100 text-gray-900">
    ...
    <section class="h-screen flex items-center justify-center text-center bg-cover bg-center" style="background-image: url('Media\hero1.webp');">
        <div class="bg-black bg-opacity-50 p-8 rounded-lg">
            ...
            <a href="#donate" class="mt-6 inline-block bg-yellow-400 text-black px-6 py-3 rounded-lg font-bold">Donate Now</a>
        </div>
    </section>
    
    <section id="about" class="p-8 bg-white text-center">
        <h2 class="text-3xl font-bold">About Us</h2>
        <p class="mt-4">Mathare Care Center is dedicated to improving the lives of children with disabilities through education, support, and community engagement.</p>
    </section>
